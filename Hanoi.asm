...
;__CONVERSÃO DE INTEIRO PARA STRING (itoa);
...
convert_loop:
    ...
    jmp     done      ; Pula para a conclusão
    
zero_case:
    mov     byte [ebx], '0'    ; Se o número for zero, coloca '0' no buffer
    inc     ebx                ; Move o ponteiro para a próxima posição
    
done:
    mov     byte [ebx], 0      ; Adiciona o caractere nulo ao final da string
    ret
